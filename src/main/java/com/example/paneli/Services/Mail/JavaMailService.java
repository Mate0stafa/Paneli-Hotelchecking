...
//                    "    <img src=\"https://allbookers.com/images/allbookersorange.png\" style=\"width: 350px; margin-bottom: 5px;\"></img>\n" +
    ...
    public void kypformadmin(Property property) throws MessagingException {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        String useri = authentication.getName().toUpperCase();


        MimeMessage message = sender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message, true);
        helper.setTo("info@allbookers.com");
        helper.setSubject(property.getName() + " Submitted KYP Form for Review");
        String hostType;
         if(property.isProfessionalHost()){
        ...
        String emailContent =
                "<div style='font-family: Arial, sans-serif; font-size: 14px; color: #333;'>"
                        ...
                        + "<img src='https://www.allbookers.com/images/logoallbookers.png' alt='AllBookers Logo' style='max-width: 200px;margin-left:14%'>"
                        + "</div>"
                       +  "<div style=\"margin-left:14%;\">"
                        + "<p>Hello,</p>"
                        + "<p> A new property has just submitted the <strong> Know Your Property (KYP) </strong>   form and is awaiting review.\n "  + "</p>"
                        + "<p><strong>Property Details:</strong> "  +
                            "<ul> <li> <strong> Property Name: </strong>" + property.getName() + "</li>" +
                        "<li> <strong> Host Type: </strong>" + hostType + "</li>" +
                        "<li> <strong> Location: </strong>" + property.getAddress().getStreet() + ','  + property.getCity() + ','
                        + property.getAddress().getCity().getCounty().getName() + ',' + property.getCountry() + "</li>" +
                        "<li> <strong> Submitted by User,User Id: </strong>" +  useri + "</li>" +
                        "<li> <strong> Submission Date: </strong>" +  property.getSubmissionDate() +   "</li> </ul>" +
                          "</p>" +
                        "<p> Please review the submitted KYP form and ensure all necessary details and documentation are complete.\n" +
                        "Once the review is finalized, you can either confirm the property or request additional information from\n" +
                        "the host if needed. </p>" +
                        "<p> You can access the KYP submission and property details by logging into the admin dashboard.\n </p>"
                         + "</div>"
                        + "</div>";
    ...
    @Async
    public void confirmKYPform(Property property) throws MessagingException {

        MimeMessage message = sender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message, true);
        helper.setTo("info@allbookers.com");
         helper.setSubject("Confirmation of KYP Form Submission");
        ...
        String emailContent =
                "<div style='font-family: Arial, sans-serif; font-size: 14px; color: #333;'>"
                        ...
                        + "</div>"
                        +  "<div style=\"margin-left:14%;\">"
                        + "<p>Dear, " + property.getName() + "</p>"
                        + "<p> We are pleased to inform you that your \"Know Your Property\" (KYP) form has been successfully reviewed and confirmed..\n "  + "</p>"
                        + "<p> Your property details have now been fully updated and your listing is in good standing with our\n" +
                        "compliance requirements. If you have any further updates or changes in the future, please don’t\n" +
                        "hesitate to reach out to our support team. </p>" +
                        "<p> We look forward to continuing our successful partnership and driving more bookings for your\n" +
                        "property!\n\n </p>"
                        +"<p> Best regards,\n" +
                        "Allbookers.com </p>"
                        + "</div>"
    ...
    public void refusedKYPform(Property property) throws MessagingException {

        MimeMessage message = sender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message, true);
        helper.setTo("info@allbookers.com");
//        helper.setTo("workklea@gmail.com");
        helper.setSubject("Action Required: KYP Form Submission Refused");
        ...
        String emailContent =
                "<div style='font-family: Arial, sans-serif; font-size: 14px; color: #333;'>"
                        ...
                        +  "<div style=\"margin-left:14%;\">"
                        + "<p>Dear, " + property.getName() + "</p>"
                        + "<p> We regret to inform you that the submission of your \"Know Your Property\" (KYP) form has\n" +
                        "been refused due to incomplete or incorrect information provided. Unfortunately, we cannot\n" +
                        "process your form until the required details are updated. </p>" +
                        "<p> Please review your submission and make the necessary corrections as soon as possible. You can\n" +
                        "access the form by logging into your account and navigating to the KYP section.\n </p>"+
